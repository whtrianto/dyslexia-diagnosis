...
<h1 class="h3 mb-0">
    Data CF Disgrafia
    <button class="btn btn-info btn-sm border-0 float-right" type="button" data-toggle="modal" data-target="#Tambah1_tb_rule">Tambah</button>
</h1>
<hr>
<table class="table table-striped table-sm table-bordered dt-responsive nowrap" id="table" width="100%">
    ...
    <tbody>
        <?php
        $no = 1;
        $data_id_penyakit = mysqli_query($kon, "SELECT * FROM 1_tb_rule ORDER BY id ASC");
...
<?php
// Proses Tambah
if (isset($_POST['Tambah1_tb_rule'])) {
    ...
    $insert = mysqli_query($kon, "INSERT INTO 1_tb_rule (id_penyakit, id_gejala, certainty_factor) VALUES ('$id_penyakit','$id_gejala','$certainty_factor')");
...
if (isset($_POST['SimpanEdit'])) {
    ...
    $update = mysqli_query($kon, "UPDATE 1_tb_rule SET id_penyakit='$id_penyakit', id_gejala='$id_gejala', certainty_factor='$certainty_factor' WHERE id='$id'");
...
if (!empty($_GET['hapus'])) {
    $id = $_GET['hapus'];
    $hapus = mysqli_query($kon, "DELETE FROM 1_tb_rule WHERE id='$id'");
    echo $hapus ? '<script>window.location.href="cf1.php";</script>' : '<script>alert("Gagal Hapus Data");window.location.href="cf1.php";</script>';
}
?>

<!-- Modal Tambah -->
<div class="modal fade" id="Tambah1_tb_rule" tabindex="-1" role="dialog">
        ...
        <div class="modal-content border-0">
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="Tambah1_tb_rule" class="btn btn-success">Simpan</button>
                </div>
            </form>
        </div>
    </div>
...
<?php
$data_id_penyakit_modal = mysqli_query($kon, "SELECT * FROM 1_tb_rule ORDER BY id ASC");
