        ...
        <div class="row">
            <div class="col-md-6">
                <table class="table table-borderless">
                    ...
                    <tr>
                        <td><strong>Jenis Identifikasi:</strong></td>
                        <td>
                            <span class="badge badge-<?php echo $data['jenis_diagnosa'] == 'disleksia' ? 'info' : 'warning'; ?>">
                                <?php echo ucfirst($data['jenis_diagnosa']); ?>
                            </span>
                        </td>
                    </tr>
                    <tr>
                        <td><strong>Hasil Identifikasi:</strong></td>
                    ...
                    <tr>
                        <td><strong>Tanggal Identifikasi:</strong></td>
            ...
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    foreach ($gejala_array as $gejala) {
                        echo "<span class='badge badge-secondary mr-1 mb-1'>$gejala</span>";
                    }
                    ?>
                </div>
                        ...
                        <tbody>
                            ...
                            if ($cf_semua) {
                                foreach ($cf_semua as $id_penyakit => $cf_value) {
                                    ...
                                    $badge_class = $cf_percent >= 80 ? 'primary' : ($cf_percent >= 60 ? 'warning' : 'danger');
                            ?>
                                    <tr>
