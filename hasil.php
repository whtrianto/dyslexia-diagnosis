		...
		<div class="col-12">
			<div class="d-flex justify-content-end">
				<div class="btn-group" role="group">
					<a class="btn btn-secondary btn-lg mr-2" href="diagnosa.php" style="text-decoration: none; min-width: 120px;">
					...
					<div class="form-group">
						...
						<table class="table table-bordered" style="font-size: 15px;">
							...
							foreach ($_SESSION["certainty_factors"] as $id_penyakit => $cf_value) {
								...
								$qry = "SELECT penyakit FROM tb_penyakit WHERE id = $id_penyakit";
